public class VechicleTests
{
  public static void main(String[] args)
  {
    ...
    Vehicle newVehicle = new Vehicle("MC56WQ", 10.75, 5);
    System.out.println(newVehicle.calculateTollPrice());
    ...
    Car newCar = new Car("KXN73F", 8.50, 2, true);
    System.out.println(newCar.calculateTollPrice());
    ...
    //    Print out the calculated toll price
    Truck newTruck = new Truck("3K9JMX", 24.75, 4, 6, true);
    System.out.println(newTruck.calculateTollPrice());
    ...
    Taxi newTaxi = new Taxi("8KM23Z", 9.25, 3, true, 5);
    newTaxi.printTaxi();
    System.out.println(newTaxi instanceof Car);
    System.out.println(newTaxi instanceof Vehicle);
